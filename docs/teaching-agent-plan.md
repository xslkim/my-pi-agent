...
**实际行数**（T24 回填，按 git tag 实测）：L1 176 · L2 +246 · L3 +313 · L4 +331 · L5 +40，**累计 1106 / 1400**。L4 略超课预算（331 > 300）：重试（T17）与 abort 加固期间并入 `llm.ts` 的增改落在了 L4 窗口；总量余量充足，不再回砍——数字如实记录，课堂可作「预算口径」的讨论素材。
