...
<!-- 素材复用自旧版脚本 video_res/lesson5-delivery。素材 23.8s（ffprobe 实测 23.833s，1920×1080 h264）；本块旁白估算约 25.8s ≥ 23.8s，安全档（超时自动截断）。 -->
...
<!-- 素材复用自旧版脚本 video_res/lesson5-delivery。素材 17.1s（ffprobe 实测 17.133s，1920×1080 h264）；本块旁白估算约 29.2s ≥ 17.1s，安全档（超时自动截断）。 -->
