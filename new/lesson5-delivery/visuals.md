...
<!-- 素材复用自旧版脚本 video_res/lesson5-delivery。素材 23.8s（ffprobe 实测 23.833s，1920×1080 h264）；本块旁白估算约 26.8s（2026-08-28 改写稿，4.89 字/秒），循环约 1.13×，可接受档。 -->
...
<!-- 2026-08-28 重渲染：自 docs/runs/l5-run2.jsonl 以 0.75× 放慢回放（render.mjs --jsonl），素材 24.8s；本块旁白估算约 29.2s（2026-08-28 改写稿，4.89 字/秒），循环约 1.18×，可接受档。 -->
